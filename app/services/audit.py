...
# Never audit the audit log itself (recursion), the churny session table, or image
# blobs (binary payloads have no place in the JSON audit trail).
_EXCLUDED_TABLES = {"audit_log", "sessions", "order_images"}
